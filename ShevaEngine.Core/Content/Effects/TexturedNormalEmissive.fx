...
{	
	...
	float4 emissiveColor = tex2D(EmissiveTextureSampler,input.TextureCoordinates0);
	...
	result.RenderTarget1 = float4(saturate(AmbientLight + light) * Color.rgb * texColor.rgb + emissiveColor.rgb + saturate(specular), texColor.w);
