...
namespace ShevaEngine.PostProcesses
{
    public class GaussBlurV : BasePostProcess
    {
        ...
        protected override void PrepareEffect(Camera camera, GameTime time, IScene scene)
        {
            ...
            {
                SetBlurEffectParameters(camera.Size.Height);
        ...
        private void SetBlurEffectParameters(int resolution)
        {
            ...
            {
                new Vector2(0,0),
                new Vector2(0,(0.25f * _blurRadius) / resolution),
                new Vector2(0,(0.5f * _blurRadius) / resolution),
                new Vector2(0,(0.75f * _blurRadius) / resolution),
                new Vector2(0,_blurRadius / resolution)
            };
        }
    }
}
